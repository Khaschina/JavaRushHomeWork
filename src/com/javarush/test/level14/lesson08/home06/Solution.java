...
public class Solution
{
    public static void main(String[] args) throws Exception
    {
        ...
        Movie movie;
        List<String> arrayListForKey = new LinkedList<>();
        while(true)
            {
                ...
                {
                    arrayListForKey.add(key);
                }
                else
                    break;
            }
        for(int i = 0; i <arrayListForKey.size();i++)
        {

            movie=MovieFactory.getMovie(arrayListForKey.get(i));
